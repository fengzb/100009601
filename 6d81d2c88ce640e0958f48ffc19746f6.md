...
![3077a24abcd93f063c7510fb81ccf9bf.png][]
...
然后，你就可以在这台机器上通过http://localhost:4444/grid/console观察Selenium Hub的状态，也可以在其他机器上通过http://<Hub\_IP>:4444/grid/console观察Selenium Hub的状态。其中，<Hub\_IP>是这台Selenium Hub机器的IP地址。由于此时还没有Node注册到该Hub上，所以你看不到任何的Node信息。

启动过程和状态信息，分别如图2、3所示。

![a275424067255c72da249734a203ba98.png][]

图2 Selenium Hub启动过程

![3d73539d2b14aa45d4f2b19334eb9a15.png][]
...
如果你想自己配置这些内容，可以在启动Node的时候提供不同的启动参数。具体可以指定哪些参数，你可以参考[Selenium Grid][]的官方文档。

如图4所示为Node的启动过程，如图5所示为在Hub端注册Node的过程，如图6所示为挂载完Node后Selenium Hub的状态。

![db5edbf3d119ac17710a9640d905c596.png][]

图4 Node的启动过程

![3e4133f06d2cc5d812cef1f8f375c74b.png][]

图5 Hub端Node注册的过程

![58bf48cb7af0db82546902a3a5c99406.png][]
...
在基于Docker搭建Selenium Grid之前，你需要先安装Docker环境。具体安装方法，你可以参考[Docker的官方文][Docker][档][Docker]。
...
[3077a24abcd93f063c7510fb81ccf9bf.png]: https://static001.geekbang.org/resource/image/30/bf/3077a24abcd93f063c7510fb81ccf9bf.png
[a275424067255c72da249734a203ba98.png]: https://static001.geekbang.org/resource/image/a2/98/a275424067255c72da249734a203ba98.png
[3d73539d2b14aa45d4f2b19334eb9a15.png]: https://static001.geekbang.org/resource/image/3d/15/3d73539d2b14aa45d4f2b19334eb9a15.png
[Selenium Grid]: https://github.com/SeleniumHQ/selenium/wiki/Grid2
[db5edbf3d119ac17710a9640d905c596.png]: https://static001.geekbang.org/resource/image/db/96/db5edbf3d119ac17710a9640d905c596.png
[3e4133f06d2cc5d812cef1f8f375c74b.png]: https://static001.geekbang.org/resource/image/3e/4b/3e4133f06d2cc5d812cef1f8f375c74b.png
[58bf48cb7af0db82546902a3a5c99406.png]: https://static001.geekbang.org/resource/image/58/06/58bf48cb7af0db82546902a3a5c99406.png
